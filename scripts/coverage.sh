...
TESTS="test_config test_memory test_skill test_provider test_anthropic test_openai test_router test_agent test_channel test_cli test_shell test_file test_telegram test_web_search test_cron test_manifest test_asap_envelope test_asap_ulid test_asap_client test_asap_registry test_asap_server test_auth test_static"
